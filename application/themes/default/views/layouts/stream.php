...
?>
        ...
        <div class="nav">
            <a href="<?php echo base_url(); ?>">
                <?php
            echo getProfilePicture();  ?><h1><?php echo getSetting('siteName'); ?>'s Photostream</h1></a>
            <ol>
                <li><?php echo anchor('photos', 'Home'); ?></li>
                <li><?php
                if ($queryCount != 0){
                echo anchor('albums', 'Albums');
                }
                ?></li>
       ...
       if($queryCount == 0){
        ?>
        <h2>You have no photos yet, would you like to <a href="<?php echo base_url(); ?>admin/dashboard">add an album or some photos?</a></h2>
        <?php
       }
