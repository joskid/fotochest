...
<div class="modal">
    <div class="addUser form" id="addUser">
      ...
      <div class="formItem">
        ...
        <input type="text" name="userEmail" id="userEmail" size="50" value="<?php echo $row->email; ?>">
      </div>
      <div class="formItem">
      ...
      <div class="formItem">
        ...
        <input type="text" name="userFirstName" id="userFirstName" size="50" value="<?php echo $row->firstName; ?>">
      </div>
      <div class="formItem">
        <label>Last Name:</label>
        <input type="text" name="userLastName" id="userLastName" size="50" value="<?php echo $row->lastName; ?>">
