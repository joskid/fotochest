...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.thumbs_created'
        db.add_column('photo_manager_photo', 'thumbs_created', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.thumbs_created'
        db.delete_column('photo_manager_photo', 'thumbs_created')
