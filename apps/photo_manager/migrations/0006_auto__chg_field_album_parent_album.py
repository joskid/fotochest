...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Album.parent_album'
        db.alter_column('photo_manager_album', 'parent_album_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photo_manager.Album'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Album.parent_album'
        db.alter_column('photo_manager_album', 'parent_album_id', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['photo_manager.Album']))
