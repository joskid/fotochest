...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('photo_manager_album', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['auth.User']), keep_default=False)

        # Adding field 'Photo.user'
        db.add_column('photo_manager_photo', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Album.user'
        db.delete_column('photo_manager_album', 'user_id')

        # Deleting field 'Photo.user'
        db.delete_column('photo_manager_photo', 'user_id')
