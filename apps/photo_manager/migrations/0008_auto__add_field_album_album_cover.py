...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Album.album_cover'
        db.add_column('photo_manager_album', 'album_cover', self.gf('django.db.models.fields.files.ImageField')(max_length=400, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Album.album_cover'
        db.delete_column('photo_manager_album', 'album_cover')
