...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.deleted'
        db.add_column('photo_manager_photo', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.deleted'
        db.delete_column('photo_manager_photo', 'deleted')
