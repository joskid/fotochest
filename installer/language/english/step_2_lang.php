...
$lang['intro_text']		= 	'The first step in the installation process is to check whether your server supports FotoChest. Most servers should be able to run it without any trouble.';
